...
##########################################################################################################################################################
# O
libspice.orderc_c.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_int]
libspice.orderd_c.argtypes = [ctypes.c_int, ctypes.c_int]
libspice.orderi_c.argtypes = [ctypes.c_int, ctypes.c_int]
libspice.oscelt_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double]
...
libspice.pcklof_c.argtypes = [ctypes.c_char_p, ctypes.c_int]
libspice.pckuof_c.argtypes = [ctypes.c_int]
libspice.pcpool_c.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_int]
libspice.pdpool_c.argtypes = [ctypes.c_char_p, ctypes.c_int]
libspice.pgrrec_c.argtypes = [ctypes.c_char_p, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.pipool_c.argtypes = [ctypes.c_char_p, ctypes.c_int]
#libspice.pjelpl_c.argtypes = []
libspice.pl2nvc_c.argtypes = [ctypes.c_double, ctypes.c_double]
...
libspice.prop2b_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.prsdp_c.argtypes = [ctypes.c_char_p, ctypes.c_double]
libspice.prsint_c.argtypes = [ctypes.c_char_p, ctypes.c_int]
#libspice.psv2pl_c.argtypes = []
libspice.putcml_c.argtypes = [ctypes.c_int, ctypes.c_char_p]
libspice.pxform_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double]
...
libspice.saelgv_c.argtypes = [ctypes.c_double, ctypes.c_double]
...
libspice.sce2c_c.argtypes = [ctypes.c_int, ctypes.c_double, ctypes.c_double]
libspice.sce2t_c.argtypes = [ctypes.c_int, ctypes.c_double, ctypes.c_double]
libspice.scencd_c.argtypes = [ctypes.c_int, ctypes.c_char_p, ctypes.c_double]
libspice.scfmt_c.argtypes = [ctypes.c_int, ctypes.c_double, ctypes.c_int, ctypes.c_char_p]
libspice.scpart_c.argtypes = [ctypes.c_int, ctypes.c_int, ctypes.c_double, ctypes.c_double]
libspice.scs2e_c.argtypes = [ctypes.c_int, ctypes.c_char_p, ctypes.c_double]
libspice.sct2e_c.argtypes = [ctypes.c_int, ctypes.c_double, ctypes.c_double]
libspice.sctiks_c.argtypes = [ctypes.c_int, ctypes.c_char_p, ctypes.c_double]
#libspice.sdiff_c.argtypes = [None, None, None]
libspice.setmsg_c.argtypes = [ctypes.c_char_p]
libspice.shellc_c.argtypes = [ctypes.c_int, ctypes.c_int]
libspice.shelld_c.argtypes = [ctypes.c_int, ctypes.c_double]
libspice.shelli_c.argtypes = [ctypes.c_int, ctypes.c_int]
...
libspice.sphcyl_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double,  ctypes.c_double]
libspice.sphlat_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double,  ctypes.c_double]
libspice.sphrec_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double]
...
libspice.srfxpt_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_bool]
#libspice.ssize_c.argtypes = [ctypes.c_int, None]
libspice.stelab_c.argtypes = [ctypes.c_double]
libspice.stpool_c.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_char_p, ctypes.c_int, ctypes.c_char_p, ctypes.c_int, ctypes.c_bool]
libspice.str2et_c.argtypes = [ctypes.c_char_p, ctypes.POINTER(ctypes.c_double)]
libspice.subpnt_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.subpt_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double]
libspice.subslr_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.subsol_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double]
libspice.surfnm_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.surfpt_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_bool]
libspice.surfpv_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_bool]
libspice.swpool_c.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_int]
libspice.sxform_c.argtypes = [ctypes.c_char_p, ctypes.c_char_p, ctypes.c_double, ctypes.c_double]
libspice.szpool_c.argtypes = [ctypes.c_char_p, ctypes.c_int, ctypes.c_bool]
...
libspice.vminug_c.argtypes = [ctypes.c_int, ctypes.c_double]
libspice.vminus_c.argtypes = [ctypes.c_double]
libspice.vnorm_c.restype = ctypes.c_double
libspice.vnorm_c.argstype = [stypes.doubleVector(3)]
libspice.vpack_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double]
libspice.vperp_c.argtypes = [ctypes.c_double]
libspice.vprjp_c.argtypes = [ctypes.c_double]
libspice.vprjpi_c.argtypes = [ctypes.c_double, ctypes.c_bool]
libspice.vproj_c.argtypes = [ctypes.c_double]
libspice.vrotv_c.argtypes = [ctypes.c_double, ctypes.c_double]
libspice.vscl_c.argtypes = [ctypes.c_double, ctypes.c_double]
libspice.vsclg_c.argtypes = [ctypes.c_double, ctypes.c_int, ctypes.c_double]
libspice.vsub_c.argtypes = [ctypes.c_double]
libspice.vsubg_c.argtypes = [ctypes.c_int, ctypes.c_double]
libspice.vupack_c.argtypes = [ctypes.c_double, ctypes.c_double, ctypes.c_double]
##########################################################################################################################################################
# W
