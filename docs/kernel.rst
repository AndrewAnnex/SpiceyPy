...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: SPICE Kernel Required Reading                             |
|    :name: spice-kernel-required-reading                               |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Introduction to Kernels                                   |
|    :name: introduction-to-kernels                                     |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Text Kernels and the Kernel Pool                          |
|    :name: text-kernels-and-the-kernel-pool                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: SPICE Kernel Type Identification and Kernel Naming        |
|    :name: spice-kernel-type-identification-and-kernel-naming          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: SPICE Kernel Type Identification                          |
|    :name: spice-kernel-type-identification                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Recommendations on Kernel File Naming                     |
|    :name: recommendations-on-kernel-file-naming                       |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Binary Kernel Specifications                              |
|    :name: binary-kernel-specifications                                |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Text Kernel Specifications and Interfaces                 |
|    :name: text-kernel-specifications-and-interfaces                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Text Kernel Specifications                                |
|    :name: text-kernel-specifications                                  |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Variable Name Rules                                       |
|    :name: variable-name-rules                                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Variable Value Rules                                      |
|    :name: variable-value-rules                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Additional Text Kernel Syntax Rules                       |
|    :name: additional-text-kernel-syntax-rules                         |
|                                                                       |
| |                                                                     |
| | Line Length                                                         |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Maximum Numbers of Variables and Variable Values          |
|    :name: maximum-numbers-of-variables-and-variable-values            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Treatment of Invalid Text Kernels                         |
|    :name: treatment-of-invalid-text-kernels                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Additional Meta-kernel Specifications                     |
|    :name: additional-meta-kernel-specifications                       |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Text Kernel Interfaces - Fetching Data from the Kernel    |
|    Pool                                                               |
|    :name: text-kernel-interfaces---fetching-data-from-the-kernel-pool |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Informational Functions                                   |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Section 5 -- Kernel Management                            |
|    :name: section-5----kernel-management                              |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Loading Kernels                                           |
|    :name: loading-kernels                                             |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Kernel Priority                                           |
|    :name: kernel-priority                                             |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Path Symbols in Meta-kernels                              |
|    :name: path-symbols-in-meta-kernels                                |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying Kernels Using Relative Paths                   |
|    :name: specifying-kernels-using-relative-paths                     |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Keeping Track of Loaded Kernels                           |
|    :name: keeping-track-of-loaded-kernels                             |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Reloading Kernels                                         |
|    :name: reloading-kernels                                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Changing Kernel Priority                                  |
|    :name: changing-kernel-priority                                    |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Finding Out What's Loaded                                 |
|    :name: finding-out-whats-loaded                                    |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Unloading Kernels                                         |
|    :name: unloading-kernels                                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Loading of Non-native Text and Binary Kernels             |
|    :name: loading-of-non-native-text-and-binary-kernels               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Manipulating Kernel Pool Contents                         |
|    :name: manipulating-kernel-pool-contents                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Detecting Changes in the Kernel Pool Using Watchers       |
|    :name: detecting-changes-in-the-kernel-pool-using-watchers         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix A -- Discussion of Competing Data                |
|    :name: appendix-a----discussion-of-competing-data                  |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix B -- Glossary of Terms                           |
|    :name: appendix-b----glossary-of-terms                             |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Continued string                                          |
|    :name: continued-string                                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Incremental assignment                                    |
|    :name: incremental-assignment                                      |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Keeper (subsystem)                                        |
|    :name: keeper-subsystem                                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Kernel pool (sometimes just called \``the pool'')         |
|    :name: kernel-pool-sometimes-just-called-the-pool                  |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Kernel variable                                           |
|    :name: kernel-variable                                             |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Meta-kernel (also known as \``FURNSH kernel'')            |
|    :name: meta-kernel-also-known-as-furnsh-kernel                     |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix C -- Summary of Routines                         |
|    :name: appendix-c----summary-of-routines                           |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|       dtpool_c ( Return information about a kernel pool variable )    |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix D -- Summary of Key Text Kernel Parameter Values |
|    :name: appendix-d----summary-of-key-text-kernel-parameter-values   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix E -- Revision History                            |
|    :name: appendix-e----revision-history                              |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| discussion of vector value syntax. Added statement that blank lines   |
| in data blocks are ignored. Added comma to list of characters that    |
| may not appear in kernel variable names; removed period from this     |
| list. Updated documentation of ID words, binary kernel types, KEEPER  |
| APIs, and file name conventions to cover DSKs. Corrected description  |
| of file type inputs to KEEPER APIs. Fixed several typos.              |
|                                                                       |
| 2014 July 15, NJB (JPL)                                               |
|                                                                       |
| Updated numeric limits. Added discussion of kernel loading errors.    |
| Made small additions to discussion of file name restrictions. Added   |
| mention of treatment by GIPOOL of non-integer values. Made small      |
| addition to discussion of \``@'' time values in text kernels.         |
| Corrected a \``setparamsize'' setting that truncated function names.  |
| Changed quoting style to standard (\`\` '')for .ftm documents.        |
| Changed double quotes to single quotes in IDL code example. Made      |
| other miscellaneous, minor edits.                                     |
|                                                                       |
| 2011 October 24, CHA (JPL)                                            |
|                                                                       |
| Re-organization and added further clarifications. Also added Appendix |
| A discussion of competing data, Appendix B providing a glossary of    |
| terms, and an Appendix C summarizing kernel subsystem functions.      |
| Includes much information provided by N. Bachman.                     |
|                                                                       |
| 2011 APR 18, EDW (JPL)                                                |
|                                                                       |
| Edits for clarity and organization.                                   |
|                                                                       |
| Added description of the 32 character limit on user defined kernel    |
| pool variable names for `furnsh_c <../cspice/furnsh_c.html>`__,       |
| `lmpool_c <../cspice/lmpool_c.html>`__,                               |
| `pcpool_c <../cspice/pcpool_c.html>`__,                               |
| `pdpool_c <../cspice/pdpool_c.html>`__, and pdpool_c. Added mention   |
| that tabs are now allowed in text kernels.                            |
| `kclear_c <../cspice/kclear_c.html>`__ now included in routines list. |
|                                                                       |
| 2009 APR 08, BVS (JPL)                                                |
|                                                                       |
| Previous edits.                                                       |
