...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Planes Required Reading                                   |
|    :name: planes-required-reading                                     |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| |                                                                     |
|                                                                       |
| - ``1.`` \`Calculus, Vol. II'. Tom Apostol. John Wiley and Sons,      |
|   1969. See Chapter 5, \`Eigenvalues of Operators Acting on Euclidean |
|   Spaces'.                                                            |
|                                                                       |
| - ``2.`` Ellipses required reading                                    |
|   (`ellipses.req <../req/ellipses.html>`__).                          |
|                                                                       |
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Plane Data Type Description                               |
|    :name: plane-data-type-description                                 |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Constructing planes                                       |
|    :name: constructing-planes                                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Construct a plane from a normal vector and constant       |
|    :name: construct-a-plane-from-a-normal-vector-and-constant         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Construct a plane from a normal vector and a point        |
|    :name: construct-a-plane-from-a-normal-vector-and-a-point          |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Construct a plane from a point and spanning vectors       |
|    :name: construct-a-plane-from-a-point-and-spanning-vectors         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Access plane data elements                                |
|    :name: access-plane-data-elements                                  |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Converting between representations of planes              |
|    :name: converting-between-representations-of-planes                |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Translating planes                                        |
|    :name: translating-planes                                          |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Applying linear transformations to planes                 |
|    :name: applying-linear-transformations-to-planes                   |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Finding the limb of an ellipsoid                          |
|    :name: finding-the-limb-of-an-ellipsoid                            |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| |                                                                     |
| | Corrections were made to comments in code example that computes     |
|   altitude of ray above the limb of an ellipsoid. Previously, the     |
|   quantity computed was incorrectly described as the altitude of a    |
|   ray above an ellipsoid.                                             |
+-----------------------------------------------------------------------+
