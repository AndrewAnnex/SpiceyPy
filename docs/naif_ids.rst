...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: NAIF Integer ID codes                                     |
|    :name: naif-integer-id-codes                                       |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| - ``1.`` This document and ID-to-name mapping software include both   |
...
|                                                                       |
| - ``2.`` This document and ID-to-name mapping software contain only a |
...
|   missions).                                                          |
|                                                                       |
| - ``3.`` This document and ID-to-name mapping software contain only a |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Use of Code-to-Name/Name-to-Code Mappings from SPICE      |
|    :name: use-of-code-to-namename-to-code-mappings-from-spice         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Use of an External Mapping Definition Kernel              |
|    :name: use-of-an-external-mapping-definition-kernel                |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| - ``1.`` All ID codes MUST be listed in the kernel variable           |
|   NAIF_BODY_CODE, and all names MUST be listed in the kernel variable |
|   NAIF_BODY_NAME.                                                     |
|                                                                       |
| - ``2.`` The CSPICE system can access 14983 external name-ID pairs    |
|   defined via a text kernel. CSPICE signals an error when the number  |
|   of assignments exceeds 14983.                                       |
|                                                                       |
| - ``3.`` Names must be no longer than 36 characters. SPICE truncates  |
|   characters beyond 36th without signaling an error.                  |
|                                                                       |
| - ``4.`` You may assign an ID code to multiple names. A               |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: NAIF Object ID numbers                                    |
|    :name: naif-object-id-numbers                                      |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Planets and Satellites                                    |
|    :name: planets-and-satellites                                      |
|                                                                       |
| |                                                                     |
...
| 512. (Note the fragments of comet Shoemaker Levy 9 are exceptions to  |
| this rule.)                                                           |
| ::                                                                    |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Earth Orbiting Spacecraft.                                |
|    :name: earth-orbiting-spacecraft.                                  |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Inertial and Non-inertial Reference Frames                |
|    :name: inertial-and-non-inertial-reference-frames                  |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Spacecraft Clocks.                                        |
|    :name: spacecraft-clocks.                                          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
