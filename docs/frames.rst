...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame Functions in CSPICE                                 |
|    :name: frame-functions-in-cspice                                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame Transformation Functions                            |
|    :name: frame-transformation-functions                              |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame Information Functions                               |
|    :name: frame-information-functions                                 |
|                                                                       |
| |                                                                     |
...
|       frinfo_c ( frcode, &cent,  &class,  &clssid, &found )           |
|       cidfrm_c ( cent,   lenout, &frcode, frname,  &found )           |
|       cnmfrm_c ( cname,  lenout, &frcode, frname,  &found )           |
|       ccifrm_c ( class,  clssid, lenout,  &frcode, frname,            |
|                  &cent,  &found )                                     |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frames Supported in SPICE                                 |
|    :name: frames-supported-in-spice                                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Kernels Needed For Computing Frame Transformations        |
|    :name: kernels-needed-for-computing-frame-transformations          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Creating a Frame Kernel                                   |
|    :name: creating-a-frame-kernel                                     |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| - ``1.`` Inertial frames. These frames do not rotate with respect to  |
...
|   1.                                                                  |
|                                                                       |
| - ``2.`` PCK (body-fixed) frames. PCK frames are reference frames     |
...
|   with CK frames is 3.                                                |
|                                                                       |
| - ``4.`` Fixed offset frames. These frames are also called Text       |
...
|                                                                       |
| - ``6.`` Switch frames. These are time-dependent frames that choose   |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying a New Frame                                    |
|    :name: specifying-a-new-frame                                      |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| - ``5.`` the internal ID code used by the class (CLASS_ID) to refer   |
|   to the frame.                                                       |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Guidelines for Frame Specification                        |
|    :name: guidelines-for-frame-specification                          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Selecting a Frame ID                                      |
|    :name: selecting-a-frame-id                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Selecting the Class                                       |
|    :name: selecting-the-class                                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Selecting the Center                                      |
|    :name: selecting-the-center                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Selecting a Class ID                                      |
|    :name: selecting-a-class-id                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame IDs Reserved for Public Use                         |
|    :name: frame-ids-reserved-for-public-use                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Why have a Frame ID and a Class ID?                       |
|    :name: why-have-a-frame-id-and-a-class-id                          |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Putting the Pieces Together                               |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Connecting an Object to its Body-fixed Frame              |
|    :name: connecting-an-object-to-its-body-fixed-frame                |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: The rest of the frame information                         |
|    :name: the-rest-of-the-frame-information                           |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Inertial Frames                                           |
|    :name: inertial-frames                                             |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: SCLK and SPK ID codes                                     |
|    :name: sclk-and-spk-id-codes                                       |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| - ``1.`` as a 3 by 3 matrix, M, that converts vectors from the TK     |
...
|                                                                       |
| - ``2.`` as a set of 3 Euler angles and axes that can be used to      |
|   produce M                                                           |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a TK Frame Using a Matrix                        |
|    :name: defining-a-tk-frame-using-a-matrix                          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a TK Frame Using Euler Angles                    |
|    :name: defining-a-tk-frame-using-euler-angles                      |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a TK Frame Using a SPICE-style Quaternion        |
|    :name: defining-a-tk-frame-using-a-spice-style-quaternion          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Gaining Flexibility via TK Frames                         |
|    :name: gaining-flexibility-via-tk-frames                           |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Parameterized Dynamic Frame Families                      |
|    :name: parameterized-dynamic-frame-families                        |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Required Keywords for Parameterized Dynamic Frames        |
|    :name: required-keywords-for-parameterized-dynamic-frames          |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Conditional Keywords for Parameterized Dynamic Frames     |
|    :name: conditional-keywords-for-parameterized-dynamic-frames       |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Two-Vector Frames                                         |
|    :name: two-vector-frames                                           |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a Two-Vector Frame in a Frame Kernel             |
|    :name: defining-a-two-vector-frame-in-a-frame-kernel               |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame                                   |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family                                 |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Rotation state or Freeze Epoch             |
|    :name: specifying-the-rotation-state-or-freeze-epoch               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Angular Separation Tolerance               |
|    :name: specifying-the-angular-separation-tolerance                 |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame Axis Labels                                         |
|    :name: frame-axis-labels                                           |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Vector Specifications                                     |
|    :name: vector-specifications                                       |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Observer-Target Position Vectors                          |
|    :name: observer-target-position-vectors                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Target Near point Vectors                                 |
|    :name: target-near-point-vectors                                   |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Observer-Target Velocity Vectors                          |
|    :name: observer-target-velocity-vectors                            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Mean Equator and Equinox of Date Frames                   |
|    :name: mean-equator-and-equinox-of-date-frames                     |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a Mean Equator and Equinox of Date Frame in a    |
|    Frame Kernel                                                       |
|    :name                                                              |
| : defining-a-mean-equator-and-equinox-of-date-frame-in-a-frame-kernel |
|                                                                       |
...
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame-1                                 |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family-1                               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Precession Model                           |
|    :name: specifying-the-precession-model                             |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying a Rotation State or Freeze Epoch               |
|    :name: specifying-a-rotation-state-or-freeze-epoch                 |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: True Equator and Equinox of Date Frames                   |
|    :name: true-equator-and-equinox-of-date-frames                     |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a True Equator and Equinox of Date Frame in a    |
|    Frame Kernel                                                       |
|    :name                                                              |
| : defining-a-true-equator-and-equinox-of-date-frame-in-a-frame-kernel |
|                                                                       |
...
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame-2                                 |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family-2                               |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Precession Model                           |
|    :name: specifying-the-precession-model-1                           |
|                                                                       |
| |                                                                     |
| | Currently CSPICE supports only one precession model: the 1976 IAU   |
|   precession model for the earth.                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Nutation Model                             |
|    :name: specifying-the-nutation-model                               |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying a Rotation State or Freeze Epoch               |
|    :name: specifying-a-rotation-state-or-freeze-epoch-1               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Mean Ecliptic and Equinox of Date Frames                  |
|    :name: mean-ecliptic-and-equinox-of-date-frames                    |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a Mean Ecliptic and Equinox of Date Frame in a   |
|    Frame Kernel                                                       |
|    :name:                                                             |
|  defining-a-mean-ecliptic-and-equinox-of-date-frame-in-a-frame-kernel |
|                                                                       |
...
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame-3                                 |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family-3                               |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Precession Model                           |
|    :name: specifying-the-precession-model-2                           |
|                                                                       |
| |                                                                     |
| | Currently CSPICE supports only one precession model: the 1976 IAU   |
|   precession model for the earth.                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Mean Obliquity Model                       |
|    :name: specifying-the-mean-obliquity-model                         |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying a Rotation State or Freeze Epoch               |
|    :name: specifying-a-rotation-state-or-freeze-epoch-2               |
|                                                                       |
| |                                                                     |
...
|   indexed by axindx_3.                                                |
|                                                                       |
| - ``2.`` Rotate the axes of the frame resulting from the first        |
|   rotation by angle_2 about the axis indexed by axindx_2.             |
|                                                                       |
| - ``3.`` Rotate the axes of the frame resulting from the second       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining an Euler Frame in a Frame Kernel                 |
|    :name: defining-an-euler-frame-in-a-frame-kernel                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame-4                                 |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family-4                               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Epoch                                      |
|    :name: specifying-the-epoch                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Euler Angles                               |
|    :name: specifying-the-euler-angles                                 |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Defining a Product Frame in a Frame Kernel                |
|    :name: defining-a-product-frame-in-a-frame-kernel                  |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Base Frame                                 |
|    :name: specifying-the-base-frame-5                                 |
|                                                                       |
| |                                                                     |
...
|                                                                       |
| .. rubric:: Specifying the Frame Family                               |
|    :name: specifying-the-frame-family-5                               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying the Factors                                    |
|    :name: specifying-the-factors                                      |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Dynamic Frame Implementation Considerations               |
|    :name: dynamic-frame-implementation-considerations                 |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Simulated Recursion                                       |
|    :name: simulated-recursion                                         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: The Need for Recursion in the CSPICE Frame Subsystem      |
|    :name: the-need-for-recursion-in-the-cspice-frame-subsystem        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Implementation of Limited Simulated Recursion             |
|    :name: implementation-of-limited-simulated-recursion               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Limits on Recursion in Frame Definitions                  |
|    :name: limits-on-recursion-in-frame-definitions                    |
|                                                                       |
| |                                                                     |
...
| ::                                                                    |
|                                                                       |
|       spkezr_c ( moon, et, "GSE", "NONE", "EARTH", state, &lt );      |
|                                                                       |
|       sxform_c ( "GSE", "J2000", et, xform );                         |
|                                                                       |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Frame Derivative Accuracy                                 |
|    :name: frame-derivative-accuracy                                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Efficiency Concerns                                       |
|    :name: efficiency-concerns                                         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Specifying Switch Frames                                  |
|    :name: specifying-switch-frames                                    |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: The Base Frame List                                       |
|    :name: the-base-frame-list                                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Time Intervals Associated with Base Frames                |
|    :name: time-intervals-associated-with-base-frames                  |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Switch Frame Connections                                  |
|    :name: switch-frame-connections                                    |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Switch Frame Buffering                                    |
|    :name: switch-frame-buffering                                      |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix. \``Built in'' Inertial Reference Frames         |
|    :name: appendix.-built-in-inertial-reference-frames                |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Complete List of \``Built in'' Inertial Reference Frames  |
|    :name: complete-list-of-built-in-inertial-reference-frames         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Inertial Reference Frame References                       |
|    :name: inertial-reference-frame-references                         |
|                                                                       |
| |                                                                     |
|                                                                       |
| ::                                                                    |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Low Level Inertial Reference Frame Functions              |
|    :name: low-level-inertial-reference-frame-functions                |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix. \``Built in'' PCK-Based IAU Body-Fixed          |
|    Reference Frames                                                   |
|                                                                       |
|   :name: appendix.-built-in-pck-based-iau-body-fixed-reference-frames |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix. High Precision Earth Fixed Frames               |
|    :name: appendix.-high-precision-earth-fixed-frames                 |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix. Frame Identifiers Reserved for Earth Fixed      |
|    Frames                                                             |
|    :name: appendix.-frame-identifiers-reserved-for-earth-fixed-frames |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Appendix. Frame Definition Examples                       |
|    :name: appendix.-frame-definition-examples                         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: TK frame --- Topographic                                  |
|    :name: tk-frame-----topographic                                    |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: TK frame --- Instrument                                   |
|    :name: tk-frame-----instrument                                     |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Examples of Two-Vector Parameterized Dynamic Frames       |
|    :name: examples-of-two-vector-parameterized-dynamic-frames         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Geocentric Solar Ecliptic (GSE) Frame                     |
|    :name: geocentric-solar-ecliptic-gse-frame                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Geocentric Solar Magnetospheric (GSM) Frame               |
|    :name: geocentric-solar-magnetospheric-gsm-frame                   |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Mercury Solar Equatorial (MSEQ) Frame                     |
|    :name: mercury-solar-equatorial-mseq-frame                         |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Example: Nadir Frame for Mars Orbiting Spacecraft         |
|    :name: example-nadir-frame-for-mars-orbiting-spacecraft            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Example: Roll-Celestial Spacecraft Frame                  |
|    :name: example-roll-celestial-spacecraft-frame                     |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Examples of Mean Equator and Equinox of Date Frames       |
|    :name: examples-of-mean-equator-and-equinox-of-date-frames         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Earth Mean Equator and Equinox of Date Frames             |
|    :name: earth-mean-equator-and-equinox-of-date-frames               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Examples of True Equator and Equinox of Date Frames       |
|    :name: examples-of-true-equator-and-equinox-of-date-frames         |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Example of a Mean Ecliptic and Equinox of Date Frame      |
|    :name: example-of-a-mean-ecliptic-and-equinox-of-date-frame        |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Example of an Euler Frame                                 |
|    :name: example-of-an-euler-frame                                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Examples of Product Frames                                |
|    :name: examples-of-product-frames                                  |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: IAU_EARTH Frame, Augmented with Nutation Model            |
|    :name: iau_earth-frame-augmented-with-nutation-model               |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Dog-Leg Frame for Saturn                                  |
|    :name: dog-leg-frame-for-saturn                                    |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Examples of Switch Frames                                 |
|    :name: examples-of-switch-frames                                   |
|                                                                       |
| --------------                                                        |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Switch Frame Using Reconstructed and Predict CKs          |
|    :name: switch-frame-using-reconstructed-and-predict-cks            |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Switch Frame Using CK and Dynamic Frames                  |
|    :name: switch-frame-using-ck-and-dynamic-frames                    |
|                                                                       |
| |                                                                     |
...
| `Top <#top>`__                                                        |
|                                                                       |
| .. rubric:: Predicted Attitude Profile for Observation Planning       |
|    :name: predicted-attitude-profile-for-observation-planning         |
|                                                                       |
| |                                                                     |
